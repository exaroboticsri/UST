...
class EmbdSocket:
    ...
    def connect_to_server(self, strAddr: str, nPort: int):
...
class EmbdTcpClient:
    ...
    def start_send_thread(self):
        if self._threadSend is None:
            ...
            self._threadSend.sig_terminated.connect(self.on_terminated_recv_thread)
    ...
    def on_terminated_send_thread(self):
...
PORT = 7789  # The port used by the server
