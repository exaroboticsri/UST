...
configurable_parameters = [
                           {'name': 'base_frame_id',                'default': 'camera_link1', 'description': ''},
                           #{'name': 'imu_optical_frame_id',         'default': "'imu_link'", 'description': ''},
                           {'name': 'camera_name',                  'default': 'camera_front_up', 'description': 'camera unique name'},
                           {'name': 'serial_no',                    'default': "_136522073236", 'description': 'choose device by serial number'},
