...
configurable_parameters = [
                           {'name': 'base_frame_id',                'default': 'camera_link2', 'description': ''},
                           #{'name': 'imu_optical_frame_id',         'default': "'imu_link'", 'description': ''},
                           {'name': 'camera_name',                  'default': 'camera_front_down', 'description': 'camera unique name'},
                        #    {'name': 'serial_no',                    'default': "_141722073310", 'description': 'choose device by serial number'},
