...
def generate_launch_description():
    share_dir = ament_index_python.packages.get_package_share_directory('exa_robot')
    ...
    velocity_smoother_node = launch_ros.actions.Node(
        ...
        output='both',
        remappings=[('/velocity_smoother/input', '/nav_cmd_vel'), 
                    ('/velocity_smoother/smoothed','/cmd_vel'),
                    ('/velocity_smoother/feedback/odometry','/odom'),
                    ('/velocity_smoother/feedback/cmd_vel', '/cmd_vel')],
        parameters=[params])
